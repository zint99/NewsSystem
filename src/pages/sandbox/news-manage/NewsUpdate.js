...
export default function NewsUpdate() {
  ...
  useEffect(() => {
    ...
    defaultNewsInfo.title,
    defaultNewsInfo.category.title,
    defaultNewsInfo.categoryId,
    defaultNewsInfo.content,
  ]);
  ...
  const newsContent = (
    <div className={current === 1 ? "" : "hidden"}>
      <NewsEditor
        getNewsEditorContent={getNewsEditorContent}
        defaultNewsContent={defaultNewsInfo.content}
      />
    </div>
  );
